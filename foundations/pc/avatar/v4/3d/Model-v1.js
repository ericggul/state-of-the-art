...
const ANIMATIONS_URL = "/3d/avatars-test/animations/talking.glb";
    ...
    >
      <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
        <skinnedMesh
          ...
          morphTargetDictionary={nodes.Alpha_Joints.morphTargetDictionary}
          morphTargetInfluences={nodes.Alpha_Joints.morphTargetInfluences}
        />
        <skinnedMesh
          geometry={nodes.Alpha_Surface.geometry}
          material={materials.Alpha_Body_MAT}
          skeleton={nodes.Alpha_Surface.skeleton}
          morphTargetDictionary={nodes.Alpha_Surface.morphTargetDictionary}
          morphTargetInfluences={nodes.Alpha_Surface.morphTargetInfluences}
        />
