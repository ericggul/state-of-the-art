  ...
  return (
    <>
      <group position={[0, 0, 0]}>
        ...
        <spotLight position={[0, 3, -50]} intensity={5.0} penumbra={1} color="hsl(0, 100%, 50%)" />
        <spotLight position={[0, -3, 50]} intensity={4.0} penumbra={1} color="hsl(0, 100%, 50%)" />
        ...
        {/* Render the TubeSet if the curve is ready */}
        {curve && <TubeSet curve={curve} />}
      </group>
  ...
  return (
    <group>
      <mesh>
        ...
        <meshStandardMaterial color="#FFFFFF" roughness={0.2} metalness={1.0} side={THREE.DoubleSide} />
      </mesh>
