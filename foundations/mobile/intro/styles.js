...
export const IOSDialogContainer = styled.div`
...
export const IOSDialogMessage = styled.div`
  color: #fff;
  font-size: 13px;
  text-align: center;
  margin-bottom: 20px;
...
export const IOSButtonGroup = styled.div`
  display: flex;
...
export const IOSButton = styled.button`
  ...
  padding: 12px;
  font-size: 17px;
  color: ${(props) => (props.$primary ? "#0A84FF" : "#FF453A")};
  border-right: ${(props) =>
    props.$primary ? "1px solid rgba(255, 255, 255, 0.15)" : "none"};
  cursor: pointer;
