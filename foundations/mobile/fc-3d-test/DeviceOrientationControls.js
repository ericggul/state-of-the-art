...
// Native DeviceOrientationControls implementation
...
const DeviceOrientationControlsWrapper = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("deviceorientation", handleControlChange, true);

    return () => {
      controls.dispose();
      window.removeEventListener("deviceorientation", handleControlChange, true);
    };
  }, [camera]);
...
export default DeviceOrientationControlsWrapper;
