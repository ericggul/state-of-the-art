...
const Layer0 = dynamic(() =>
  import("@/foundations/test/0-embeddings/anim/1-1")
);
const Layer1 = dynamic(() =>
  import("@/foundations/test/1-relation/anim/0/0-1")
);
const Layer2 = dynamic(() =>
  import("@/foundations/test/1-relation/anim/2/2-1")
);
const Layer3 = dynamic(() => import("@/foundations/test/3-output/anim/1/1-1"));

const Yakitori = dynamic(() =>
  import("@/foundations/test-frontend/yakitori/0")
);
  ...
  return (
    <S.Container>
      ...
      {latestPropagation && latestPropagation.text && layerIdx == "1" && (
        <Layer1 newEmbeddings={TEST_EMBEDDINGS} />
      )}
      {latestPropagation && latestPropagation.text && layerIdx == "2" && (
        <Layer2
