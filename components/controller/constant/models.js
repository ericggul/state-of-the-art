export const MODELS = {
  "v1.x - Foundation Models": {
    ...
    "v1.1": {
      ...
      citation: 22560,
      explanation:
        "Proposed a learning rule stating that synaptic efficacy increases when neurons fire together.",
    },
    "v1.2": {
      ...
      "v1.2.3": {
        name: "MADALINE",
        year: 1960,
        place: "Bernard Widrow and Ted Hoff, Stanford University",
        citation: 4500,
        explanation:
          "First neural network applied to a real-world problem (adaptive noise cancelling), using multiple ADALINE units.",
      },
    },
    "v1.3": {
      ...
      "v1.3.2": {
        name: "Universal Approximation Implementation",
        year: 1989,
        place: "George Cybenko; Kurt Hornik",
        citation: 13800,
        explanation:
          "Proved that neural networks with a single hidden layer can approximate any continuous function.",
      },
    },
  },
  "v2.x - Memory-Based and Unsupervised Models": {
    "v2.0": {
      ...
      "v2.0.1": {
        ...
        explanation:
          "Uses binary threshold neurons; functions as associative memory for pattern retrieval.",
      },
      "v2.0.2": {
        name: "Continuous Hopfield Network",
        explanation:
          "Uses continuous activation functions, allowing for analog computation.",
      },
    },
    "v2.1": {
      ...
      "v2.1.1": {
        ...
        explanation:
          "Simplified Boltzmann machine with no connections between hidden units; useful for unsupervised learning.",
      },
      "v2.1.2": {
    ...
    "v2.2": {
      ...
      "v2.2.1": {
        ...
        citation: 1900,
        explanation:
          "An incremental algorithm that learns the topology of input data.",
      },
      "v2.2.2": {
        name: "Neural Gas",
        year: 1991,
        place: "Thomas Martinetz and Klaus Schulten",
        citation: 3100,
        explanation:
          "An algorithm for vector quantization and clustering that adapts to the data distribution.",
      },
    },
    "v2.3": {
      ...
      "v2.3.3": {
        ...
        explanation:
          "Autoencoder with sparsity constraint on hidden units, encouraging learning of useful features.",
      },
      "v2.3.4": {
        ...
        "v2.3.4.2": {
          ...
          explanation:
            "Extension of VAE that conditions data generation on auxiliary information.",
        },
      },
      "v2.3.5": {
  ...
  "v3.x - Convolutional Neural Networks": {
    ...
    "v3.1": {
      ...
      "v3.1.1": {
        name: "LeNet-1",
        explanation:
          "Early convolutional neural network for handwritten digit recognition.",
      },
      "v3.1.2": {
        name: "LeNet-5",
        year: 1998,
  ...
  "v4.x - Sequence Models and Transformers": {
    ...
    "v4.2": {
      ...
      "v4.2.1": {
        ...
        "v4.2.1.1": {
          name: "Original Transformer Model",
          explanation:
            "Foundation of modern NLP models using attention mechanisms.",
        },
        "v4.2.1.2": {
          name: "T5",
          year: 2019,
  ...
  "v5.x - Generative Models": {
    ...
    "v5.2": {
      ...
      "v5.2.2": {
        name: "NeRF Variants",
        explanation:
          "Extensions and improvements to NeRF, addressing limitations like training speed and dynamic scenes.",
      },
    },
  },
...
export const ARRAY = [
  ...
  "Universal Approximation Implementation",
  "Hopfield Networks",
  "Boltzmann Machines",
...
export const OBJECT_ARRAY = [
  { name: "McCulloch-Pitts Neuron", version: "v1.0" },
  { name: "Hebbian Learning", version: "v1.1" },
  { name: "Perceptron", version: "v1.2.1" },
  { name: "ADALINE", version: "v1.2.2" },
  { name: "MADALINE", version: "v1.2.3" },
  { name: "Backpropagation Algorithm", version: "v1.3.1" },
  { name: "Universal Approximation Implementation", version: "v1.3.2" },
  { name: "Hopfield Networks", version: "v2.0" },
  { name: "Boltzmann Machines", version: "v2.1" },
  { name: "Self-Organizing Maps", version: "v2.2" },
  { name: "Growing Neural Gas", version: "v2.2.1" },
  { name: "Neural Gas", version: "v2.2.2" },
  { name: "Basic Autoencoder", version: "v2.3.1" },
  { name: "Denoising Autoencoder", version: "v2.3.2" },
  { name: "Sparse Autoencoder", version: "v2.3.3" },
  { name: "Variational Autoencoder (VAE)", version: "v2.3.4" },
  { name: "β-VAE", version: "v2.3.4.1" },
  { name: "Conditional VAE", version: "v2.3.4.2" },
  { name: "SimCLR", version: "v2.3.5.1" },
  { name: "MoCo", version: "v2.3.5.2" },
  { name: "DINO", version: "v2.3.6.1" },
  { name: "DINOv2", version: "v2.3.6.2" },
  { name: "Neocognitron", version: "v3.0" },
  { name: "LeNet-1", version: "v3.1.1" },
  { name: "LeNet-5", version: "v3.1.2" },
  { name: "AlexNet", version: "v3.2.1" },
  { name: "VGGNet", version: "v3.2.2" },
  { name: "GoogLeNet/Inception", version: "v3.2.3" },
  { name: "ResNet", version: "v3.2.4" },
  { name: "DenseNet", version: "v3.2.5" },
  { name: "EfficientNet", version: "v3.2.6" },
  { name: "Vision Transformer (ViT)", version: "v3.3.1" },
  { name: "Swin Transformer", version: "v3.3.2" },
  { name: "DeiT", version: "v3.3.3" },
  { name: "Simple RNN (Elman Network)", version: "v4.0.1" },
  { name: "Long Short-Term Memory (LSTM)", version: "v4.0.2" },
  { name: "Peephole LSTM", version: "v4.0.2.1" },
  { name: "Bidirectional LSTM", version: "v4.0.2.2" },
  { name: "Gated Recurrent Unit (GRU)", version: "v4.0.3" },
  { name: "Basic Attention", version: "v4.1.1" },
  { name: "Self-Attention", version: "v4.1.2" },
  { name: "Transformer Architecture", version: "v4.2" },
  { name: "T5", version: "v5.0.1" },
  { name: "BART", version: "v5.0.2" },
  { name: "BERT", version: "v5.1.1" },
  { name: "RoBERTa", version: "v5.1.2" },
  { name: "GPT", version: "v5.2.1" },
  { name: "GPT-2", version: "v5.2.2" },
  { name: "GPT-3", version: "v5.2.3" },
  { name: "GPT-4", version: "v5.2.4" },
  { name: "PaLM", version: "v5.3.1" },
  { name: "PaLM 2", version: "v5.3.2" },
  { name: "LLaMA", version: "v5.4.1" },
  { name: "Falcon LLM", version: "v5.4.2" },
  { name: "Generative Adversarial Networks (GANs)", version: "v6.0" },
  { name: "DCGAN", version: "v6.0.1" },
  { name: "WGAN", version: "v6.0.2" },
  { name: "Progressive GAN", version: "v6.0.3" },
  { name: "Conditional GAN", version: "v6.0.4" },
  { name: "CycleGAN", version: "v6.0.5" },
  { name: "StyleGAN", version: "v6.0.6" },
  { name: "StyleGAN2", version: "v6.0.7" },
  { name: "StyleGAN3", version: "v6.0.8" },
  {
    name: "Denoising Diffusion Probabilistic Models (DDPM)",
    version: "v6.1.1",
  },
  { name: "Stable Diffusion", version: "v6.1.2" },
  { name: "Neural Radiance Fields (NeRF)", version: "v6.1.3" },
  { name: "Show and Tell", version: "v6.2.1" },
  { name: "Visual Question Answering (VQA) Models", version: "v6.2.2" },
  { name: "CLIP", version: "v6.2.3" },
  { name: "DALL-E", version: "v6.2.1" },
  { name: "DALL-E 2", version: "v6.2.2" },
  { name: "PaLM-E", version: "v6.3.1" },
  { name: "GPT-4V", version: "v6.3.2" },
  { name: "Deep Q-Network (DQN)", version: "v7.0.1" },
  { name: "Asynchronous Advantage Actor-Critic (A3C)", version: "v7.0.2" },
  { name: "AlphaGo", version: "v7.1.1" },
  { name: "AlphaZero", version: "v7.1.2" },
  { name: "MuZero", version: "v7.1.3" },
  { name: "MobileNet", version: "v8.0.1" },
  { name: "Neural Architecture Search (NAS) Models", version: "v8.2.1" },
  { name: "Graph Neural Networks (GNNs)", version: "v8.2.2" },
  { name: "U-Net", version: "v8.2.3" },
  { name: "Transformer-XL", version: "v9.2.1" },
  { name: "XLNet", version: "v9.2.2" },
  { name: "ELECTRA", version: "v9.2.3" },
  { name: "Switch Transformer", version: "v9.2.4" },
  { name: "ALBERT", version: "v9.2.5" },
  { name: "DistilBERT", version: "v9.2.6" },
  { name: "BigBird", version: "v9.2.7" },
  { name: "Reformer", version: "v9.2.8" },
  { name: "Longformer", version: "v9.2.9" },
  { name: "ERNIE", version: "v9.2.10" },
  { name: "XLM", version: "v9.2.11" },
  { name: "SegNet", version: "v8.2.4" },
  { name: "Capsule Networks (CapsNet)", version: "v8.3.1" },
  { name: "ELMo", version: "v9.0.1" },
  { name: "ULMFiT", version: "v9.1.1" },
  { name: "YOLO (You Only Look Once)", version: "v8.2.5" },
];
